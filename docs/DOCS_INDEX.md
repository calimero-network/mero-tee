...
| `docs/policies/kms-phala-policy-auto-pipeline.md` | KMS policy pipeline design and operating model | `kms-phala-staging-probe.yaml`, `scripts/attestation/extract_tdx_policy_candidates.py`, `scripts/policy/*.sh` | Release engineers |
