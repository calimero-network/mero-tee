...
| `docs/runbooks/platforms/phala-kms.md` | Mero KMS TEE lane deployment/operations | `mero-kms/src/main.rs`, `scripts/policy/apply-merod-kms-phala-attestation-config.sh` | Operators |
| `docs/runbooks/platforms/gcp-merod.md` | Mero Node TEE lane deployment/verification | `mero-tee/*`, `release-node-image-gcp.yaml`, `scripts/release/verify-node-image-gcp-release-assets.sh` | Operators |
...
| [`docs/DOCS_GRAPH.md`](../DOCS_GRAPH.md) | [`#system-overview`](../DOCS_GRAPH.md#system-overview), [`#attestation-flow-mero-kms-tee-lane`](../DOCS_GRAPH.md#attestation-flow-mero-kms-tee-lane) |
