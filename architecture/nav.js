/* mero-tee Architecture — Shared Navigation + Full-text Search */
(function () {
  'use strict';
  ...
  const NAV = [
    ...
    { label: 'Trust Model', href: 'trust-model.html', dot: '#3fb950' },
    { label: 'Components', href: 'components.html', dot: '#a371f7' },
    { section: 'Trust & Attestation' },
    { label: 'Key Release Flow', href: 'key-release-flow.html', dot: '#a371f7' },
    { label: 'Attestation Flow', href: 'attestation-flow.html', dot: '#f778ba' },
    { label: 'Verification', href: 'verification.html', dot: '#f0883e' },
    { section: 'Operations' },
    { label: 'Release Pipeline', href: 'release-pipeline.html', dot: '#58a6ff' },
    { label: 'Policy Management', href: 'policy-management.html', dot: '#a5ff11' },
    { label: 'Runbooks', href: 'runbooks.html', dot: '#e3b341' },
    { section: 'Reference' },
    { label: 'Config Reference', href: 'config-reference.html', dot: '#f0883e' },
      ...
      <div class="sidebar-logo">
        <div class="sidebar-logo-inner">
          ...
          <div class="sidebar-logo-text">
            <strong>Calimero <em>mero-tee</em></strong>
  ...
  async function buildIndex() {
    ...
    const results = await Promise.all(pages.map(async (page) => {
      try {
        ...
        // Extract headings for section hints
  ...
  function openSearch() {
    ...
    // Pre-fetch index in background on first open
